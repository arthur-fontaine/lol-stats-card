...
import { BottomPositionalStatistics } from "./bottom-positional-statistics";
import { generateImage } from "../../../image-generator/image-generator";

const formatData = (data: unknown[]) => {
  const realData = data.filter(item => item instanceof BottomPositionalStatistics);
...
export const bottomPositionalImgGenerator = (
  data: unknown[],
